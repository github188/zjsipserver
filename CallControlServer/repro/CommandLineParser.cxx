...
{
   char* serName = "hxhtcms"; //zhangjun add
   char* logType = "cout";
   char* logLevel = "INFO";
   char* tlsDomain = 0;
   ...
   struct poptOption table[] = {
       {"ser-name",         's',  POPT_ARG_STRING| POPT_ARGFLAG_SHOW_DEFAULT, &serName,        0, "sip service name", "hxhtcms..."}, //zhangjun add
